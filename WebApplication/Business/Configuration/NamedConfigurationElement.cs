...
namespace WebApplication.Business.Configuration
{
	public abstract class NamedConfigurationElement : ConfigurationElement
	{
		...
		protected internal virtual string InvalidNameCharacters => _invalidNameCharacters;
		protected internal virtual int MaximumNameLength => _maximumNameLength;
		...
		public virtual string Name
		{
			...
			{
				if(value == null)
					throw new ConfigurationErrorsException("The value can not be null.", new ArgumentNullException(nameof(value)));

				this[this.NamePropertyName] = value;
			}
		}

		protected internal virtual string NamePropertyName => _namePropertyName;
